...
int main(int argc, char* argv[]) {
  ...
  sudoku_print_candidates(s,"s",Region::row); cout << "\n\n";
  sudoku_print_candidates(s,"s",Region::col); cout << "\n\n";
  sudoku_print_candidates(s,"s",Region::block); cout << "\n\n";
  sudoku_print_required(s,"s",Region::row); cout << "\n\n";
  sudoku_print_required(s,"s",Region::col); cout << "\n\n";
  sudoku_print_required(s,"s",Region::block); cout << "\n\n";
